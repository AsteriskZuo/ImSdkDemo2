 ...
 */
@protocol DUIChatControllerDelegate <NSObject>
 ...
 */
- (void)chatController:(DUIChatController *)controller didSendMessage:(DUIMessageCellData *)msgCellData;
 ...
 */
- (DUIMessageCell *)chatController:(DUIChatController *)controller onShowMessageData:(DUIMessageCellData *)cellData;
 ...
 */
- (void)chatController:(DUIChatController *)chatController onSelectMoreCell:(DUIInputMoreCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
- (void)chatController:(DUIChatController *)controller onSelectMessageAvatar:(DUIMessageCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
- (void)chatController:(DUIChatController *)controller onSelectMessageContent:(DUIMessageCell *)cell;
...
*/
@interface DUIChatController : UIViewController

/**
 * 未读数控件
 */
@property DUIUnreadView *unRead;
 ...
 */
@property (weak) id<DUIChatControllerDelegate> delegate;

/**
 *  更多菜单视图数据的数据组
 *  更多菜单视图包括：拍摄、图片、视频、文件。详细信息请参考 Section\Chat\TUIMoreView.h
 */
@property NSArray<DUIInputMoreCell *> *moreMenus;
