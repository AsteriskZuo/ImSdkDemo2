...
@interface DUIInputMoreView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation DUIInputMoreView
...
- (void)setupViews
{
    ...
    [_moreCollectionView registerClass:[DUIInputMoreCell class] forCellWithReuseIdentifier:TMoreCell_ReuseId];
...
- (void)defaultLayout
{
    CGSize cellSize = [DUIInputMoreCell getSize];
...
{
    DUIInputMoreCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMoreCell_ReuseId forIndexPath:indexPath];
    DUIInputMoreCellData *data;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(_delegate && [_delegate respondsToSelector:@selector(moreView:didSelectMoreCell:)]){
        if ([cell isKindOfClass:[DUIInputMoreCell class]]) {
            [_delegate moreView:self didSelectMoreCell:(DUIInputMoreCell *)cell];;
        }
    }
}
...
{
    return [DUIInputMoreCell getSize];
}
