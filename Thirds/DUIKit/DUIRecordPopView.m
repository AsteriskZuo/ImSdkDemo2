...
@implementation DUIRecordPopView
...
- (void)setPower:(NSInteger)power
{
    ...
    _recordImage.image = [[DUIImageCache sharedInstance] getResourceFromCacheWithAutoAdd:TUIKitResource(imageName)];//缓存版本
//    _recordImage.image = [UIImage imageNamed:TUIKitResource(imageName)];//应该做个缓存吧？
}
