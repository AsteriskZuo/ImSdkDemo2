...
*/
@interface DUIFileMessageCellData : DUIMessageCellData
...
*/
@interface DUIFileMessageCell : DUIMessageCell
 ...
 */
@property (nonatomic, strong) DUIFileMessageCellData *fileData;
