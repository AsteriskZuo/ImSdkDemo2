 ...
 */
@protocol DUIInputBarViewDelegate <NSObject>
/**
 *  点击表情按钮，即“笑脸”后的回调委托。
...
*/
@interface DUIInputBarView : UIView
 ...
 *  继承自 UITextView
 */
@property (nonatomic, strong) DUIInputBarTextView *inputTextView;
 ...
 */
@property (nonatomic, weak) id<DUIInputBarViewDelegate> delegate;
