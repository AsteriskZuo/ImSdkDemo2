...
@class DUIGroupPendencyCellData;
...
*
*/
@interface DUIGroupPendencyViewModel : NSObject
 ...
 */
@property (nonatomic, strong, readonly) NSArray<DUIGroupPendencyCellData *> *dataList;

/**
 *  是否具有下一个请求数据。
 *  加载数据时，当前群组的请求列表还有未读取出时，hasNextData 为 YES。
 */
@property (nonatomic, assign, readonly) BOOL hasNextData;
 ...
 *  即当前群组请求的未处理数目。
 */
@property (nonatomic, assign, readonly) int unReadCnt;
