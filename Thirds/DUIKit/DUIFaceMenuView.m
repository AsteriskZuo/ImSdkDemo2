...
@interface DUIFaceMenuView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) NSMutableArray *data;
@end

@implementation DUIFaceMenuView
...
- (void)setupViews
{
    ...
    [_menuCollectionView registerClass:[DUIFaceMenuCell class] forCellWithReuseIdentifier:TMenuCell_ReuseId];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row % 2 == 0){
        DUIFaceMenuCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMenuCell_ReuseId forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSInteger i = 0; i < _data.count; ++i) {
        DUIFaceMenuCellData *data = _data[i];
