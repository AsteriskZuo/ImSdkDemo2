 ...
 */
@protocol DUIInputControllerDelegate <NSObject>
 ...
 */
@property (nonatomic, strong) DUIInputBarView *inputBar;
 ...
 */
@property (nonatomic, strong) DUIFaceView *faceView;
 ...
 */
@property (nonatomic, strong) DUIFaceMenuView *menuView;
 ...
 */
@property (nonatomic, strong) DUIInputMoreView *moreView;

/**
 *  实现 TInputControllerDelegate 协议的委托。
 */
@property (nonatomic, weak) id<DUIInputControllerDelegate> delegate;
